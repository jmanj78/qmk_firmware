...
enum layers {
  ...
  const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT( \
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_4, KC_5, KC_6, XXXXXXX, XXXXXXX, TD(MUTE_NVDA), XXXXXXX, \
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_1, KC_2, KC_3, XXXXXXX, XXXXXXX, KC_VOLU, XXXXXXX, \
        XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, KC_0  , XXXXXXX, XXXXXXX, KC_WH_L, KC_VOLD, KC_WH_R \
        ),
    [_FN] = LAYOUT( \
